...
@Entity (
        tableName = EMSRecord.TABLE_NAME,
        indices = {
                @Index(value = {EMSRecord.COL_USER_ID, EMSRecord.COL_VITAL_TYPE, EMSRecord.COL_TIMESTAMP_MS}),
                @Index(value = {EMSRecord.COL_USERNAME, EMSRecord.COL_TIMESTAMP_MS})
        }
)
public class EMSRecord {
    ...
    public EMSRecord(String userId, String username, int vitalType,
